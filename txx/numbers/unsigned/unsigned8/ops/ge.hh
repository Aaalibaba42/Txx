...
namespace Unsigned8GEImpl
{
    template <Unsigned8_t LHS, Unsigned8_t RHS>
    struct Unsigned8GE;

    template <Unsigned8_t LHS, Unsigned8_t RHS>
    using Unsigned8GE_v = Unsigned8GE<LHS, RHS>::result;

    template <Unsigned8_t Same>
    struct Unsigned8GE<Same, Same>
    {
        using result = True;
    };
    ...
    template <Bit_t A0, Bit_t A1, Bit_t A2, Bit_t A3, Bit_t A4, Bit_t A5,
              ...
              Bit_t B5, Bit_t B6>
    struct Unsigned8GE<Unsigned8<A0, A1, A2, A3, A4, A5, A6, One>,
    ...
    template <Bit_t A0, Bit_t A1, Bit_t A2, Bit_t A3, Bit_t A4, Bit_t A5,
              Bit_t A6, Bit_t B0, Bit_t B1, Bit_t B2, Bit_t B3, Bit_t B4,
              Bit_t B5, Bit_t B6>
    struct Unsigned8GE<Unsigned8<A0, A1, A2, A3, A4, A5, A6, Zero>,
    ...
    template <Bit_t A0, Bit_t A1, Bit_t A2, Bit_t A3, Bit_t A4, Bit_t A5,
              ...
              Bit_t C7>
    struct Unsigned8GE<Unsigned8<A0, A1, A2, A3, A4, A5, One, C7>,
    ...
    template <Bit_t A0, Bit_t A1, Bit_t A2, Bit_t A3, Bit_t A4, Bit_t A5,
              Bit_t B0, Bit_t B1, Bit_t B2, Bit_t B3, Bit_t B4, Bit_t B5,
              Bit_t C7>
    struct Unsigned8GE<Unsigned8<A0, A1, A2, A3, A4, A5, Zero, C7>,
    ...
    struct Unsigned8GE<Unsigned8<A0, A1, A2, A3, A4, One, C6, C7>,
    ...
    template <Bit_t A0, Bit_t A1, Bit_t A2, Bit_t A3, Bit_t A4, Bit_t B0,
              Bit_t B1, Bit_t B2, Bit_t B3, Bit_t B4, Bit_t C6, Bit_t C7>
    struct Unsigned8GE<Unsigned8<A0, A1, A2, A3, A4, Zero, C6, C7>,
    ...
    struct Unsigned8GE<Unsigned8<A0, A1, A2, A3, One, C5, C6, C7>,
    ...
    template <Bit_t A0, Bit_t A1, Bit_t A2, Bit_t A3, Bit_t B0, Bit_t B1,
              Bit_t B2, Bit_t B3, Bit_t C5, Bit_t C6, Bit_t C7>
    struct Unsigned8GE<Unsigned8<A0, A1, A2, A3, Zero, C5, C6, C7>,
    ...
    struct Unsigned8GE<Unsigned8<A0, A1, A2, One, C4, C5, C6, C7>,
    ...
    template <Bit_t A0, Bit_t A1, Bit_t A2, Bit_t B0, Bit_t B1, Bit_t B2,
              Bit_t C4, Bit_t C5, Bit_t C6, Bit_t C7>
    struct Unsigned8GE<Unsigned8<A0, A1, A2, Zero, C4, C5, C6, C7>,
    ...
    struct Unsigned8GE<Unsigned8<A0, A1, One, C3, C4, C5, C6, C7>,
    ...
    template <Bit_t A0, Bit_t A1, Bit_t B0, Bit_t B1, Bit_t C3, Bit_t C4,
              Bit_t C5, Bit_t C6, Bit_t C7>
    struct Unsigned8GE<Unsigned8<A0, A1, Zero, C3, C4, C5, C6, C7>,
    ...
    template <Bit_t A0, Bit_t B0, Bit_t C2, Bit_t C3, Bit_t C4, Bit_t C5,
              Bit_t C6, Bit_t C7>
    struct Unsigned8GE<Unsigned8<A0, One, C2, C3, C4, C5, C6, C7>,
    ...
    template <Bit_t A0, Bit_t B0, Bit_t C2, Bit_t C3, Bit_t C4, Bit_t C5,
              Bit_t C6, Bit_t C7>
    struct Unsigned8GE<Unsigned8<A0, Zero, C2, C3, C4, C5, C6, C7>,
    ...
    template <Bit_t C1, Bit_t C2, Bit_t C3, Bit_t C4, Bit_t C5, Bit_t C6,
              Bit_t C7>
    struct Unsigned8GE<Unsigned8<One, C1, C2, C3, C4, C5, C6, C7>,
    ...
    template <Bit_t C1, Bit_t C2, Bit_t C3, Bit_t C4, Bit_t C5, Bit_t C6,
              Bit_t C7>
    struct Unsigned8GE<Unsigned8<Zero, C1, C2, C3, C4, C5, C6, C7>,
                       Unsigned8<One, C1, C2, C3, C4, C5, C6, C7>>
    {
        using result = False;
    };

    struct Unsigned8GEFunc
    {
        template <Unsigned8_t LHS, Unsigned8_t RHS>
        struct apply
        {
            ...
            using result = Unsigned8GE_v<LHS, RHS>;
        };
    };

} // namespace Unsigned8GEImpl

using Unsigned8GEImpl::Unsigned8GEFunc;
using Unsigned8GEImpl::Unsigned8GE_v;
