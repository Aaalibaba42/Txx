...
namespace list_append_tests
{
    ...
    using _t2 = AssertEq<Append_v<bu4, List<bu1, bu2, bu3>>, List<bu1, bu2, bu3, bu4>>::result;
    using _t3 = AssertEq<Append_v<bu5, List<bu2, bu4>>, List<bu2, bu4, bu5>>::result;
    ...
    using _t9 = AssertEq<Append_v<bu2, List<bu2, bu3, bu2>>, List<bu2, bu3, bu2, bu2>>::result;
    using _t10 = AssertEq<Append_v<bu4, List<bu5>>, List<bu5, bu4>>::result;
    using _t11 = AssertEq<List<bu5>, List<bu5>>::result;
    using _t12 = AssertEq<Append_v<bu6, List<bu1, bu2>>, List<bu1, bu2, bu6>>::result;
    using _t13 = AssertEq<List<bu1, bu2>, List<bu1, bu2>>::result;
    using _t14 = AssertEq<Append_v<bu3, List<bu4, bu5, bu6>>, List<bu4, bu5, bu6, bu3>>::result;
    ...
    using _t22 = AssertEq<Append_v<bu4, List<bu5, bu6, bu1, bu2, bu3, bu4, bu5>>,
