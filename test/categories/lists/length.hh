...
namespace list_legth_tests
{
    ...
    using _t5 = AssertEq<Length_v<List<bu1, bu2, bu3, bu4, bu5, bu6>>, bu6>::result;
    ...
    using _t11 = AssertEq<Length_v<List<bu1, bu2, bu3, bu4, bu5, bu6>>, bu6>::result;
    using _t12 = AssertEq<Length_v<List<bu5, bu4, bu3, bu2, bu1, bu6, bu7>>, bu7>::result;
    using _t13 = AssertEq<Length_v<List<bu1, bu2, bu3, bu4, bu5, bu6, bu7, bu8>>, bu8>::result;
    using _t14 = AssertEq<Length_v<List<bu9, bu8, bu7, bu6, bu5, bu4, bu3, bu2, bu1>>,
                          bu9>::result;
} // namespace list_legth_tests
