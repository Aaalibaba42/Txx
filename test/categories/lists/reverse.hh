...
namespace list_reverse_tests
{
    ...
    using _t3 = AssertEq<Reverse_v<List<bu1, bu2, bu3, bu4>>,
                         List<bu4, bu3, bu2, bu1>>::result;
    using _t4 =
        AssertEq<Reverse_v<List<bu2, bu3, bu2>>, List<bu2, bu3, bu2>>::result;
    ...
    using _t10 =
        AssertEq<Reverse_v<List<bu3, bu4, bu5>>, List<bu5, bu4, bu3>>::result;
    using _t11 = AssertEq<List<bu3, bu4, bu5>, List<bu3, bu4, bu5>>::result;
    using _t12 = AssertEq<Reverse_v<List<bu2, bu3, bu4, bu5>>,
                          List<bu5, bu4, bu3, bu2>>::result;
    using _t13 =
    ...
    using _t20 =
        AssertEq<Reverse_v<List<bu1, bu2, bu3, bu4, bu5, bu6, bu7, bu8>>,
    ...
    using _t22 =
        AssertEq<Reverse_v<List<bu9, bu8, bu7, bu6, bu5, bu4, bu3, bu2, bu1>>,
                 List<bu1, bu2, bu3, bu4, bu5, bu6, bu7, bu8, bu9>>::result;
    using _t23 =
        AssertEq<List<bu9, bu8, bu7, bu6, bu5, bu4, bu3, bu2, bu1>,
