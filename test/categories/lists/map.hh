...
namespace list_map_tests
{
    // Incrementation
    using _t0 =
        AssertEq<Map_v<IncFunc, List<bu1, bu2>>, List<bu2, bu3>>::result;
    ...
    using _t7 = AssertEq<Map_v<LengthFunc, List<List<bu1>, List<bu2>>>,
                         List<bu1, bu1>>::result;
    using _t8 =
        AssertEq<Map_v<LengthFunc, List<List<bu1, bu2>, List<bu3, bu5, bu8>>>,
                 List<bu2, bu3>>::result;
    using _t9 = AssertEq<
        Map_v<LengthFunc, List<List<>, List<bu1, bu2>, List<bu3, bu5, bu8>>>,
    ...
    // List Reverse
    using _t11 =
        AssertEq<Map_v<ReverseFunc, List<List<>>>, List<List<>>>::result;
    using _t12 = AssertEq<Map_v<ReverseFunc, List<List<bu1>, List<bu2>>>,
                          List<List<bu1>, List<bu2>>>::result;
    using _t13 =
        AssertEq<Map_v<ReverseFunc, List<List<bu1, bu2>, List<bu3, bu5, bu8>>>,
                 List<List<bu2, bu1>, List<bu8, bu5, bu3>>>::result;
    using _t14 = AssertEq<
        Map_v<ReverseFunc, List<List<>, List<bu1, bu2>, List<bu3, bu5, bu8>>>,
